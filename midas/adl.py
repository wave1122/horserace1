# GitHub: https://github.com/sapphire921/midas_pro
...
def rolling(y_in, x_in, start_date, end_date, xlag, ylag, horizon, forecast_horizon=1, poly='beta'):
    ...
    while start_loc + window_size < (len(y_in.index) - forecast_horizon):
        ...
        preds_IS = forecast(x, yl, res) # compute in-sample predictions

        rmse_IS.append( rmse(preds_IS.values, y.values) )
    ...
    return (np.median(rmse_IS), rmse(preds, targets),
